...
knn(ridmov_input_norm, newdata_input_norm, ridmov_output, 1)

knn(ridmov_input_norm, newdata_input_norm, ridmov_output, 2)

knn(ridmov_input_norm, newdata_input_norm, ridmov_output, 3)

knn(ridmov_input_norm, newdata_input_norm, ridmov_output, 4)

knn(ridmov_input_norm, newdata_input_norm, ridmov_output, 5)
